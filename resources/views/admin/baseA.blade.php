  ...
  <div class="flex">
    ...
    <aside class="w-60 bg-white h-screen border-r border-slate-200">
        <nav class="py-6">
            <ul>
                <li class="relative">
                    <a href="{{route('admin.dashboard')}}" class="flex items-center px-6 py-2 {{ request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-[#1767A4] font-semibold' : 'text-slate-700' }}">
                ...
                <li class="relative">
                    <a href="{{route('gestion.index')}}" class="flex items-center px-6 py-2 {{ request()->routeIs('gestion.index') || request()->routeIs('admin.users.*') ? 'bg-blue-50 text-[#1767A4] font-semibold' : 'text-slate-700' }}">
                        @if(request()->routeIs('gestion.index') || request()->routeIs('admin.users.*'))
                        <div class="absolute left-0 top-0 h-full w-1 bg-[#1767A4]"></div>
                        @endif
                        <svg class="mr-4 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="relative">
                    <a href="#" class="flex items-center px-6 py-2 {{ request()->routeIs('admin.ia.*') ? 'bg-blue-50 text-[#1767A4] font-semibold' : 'text-slate-700' }}">
                        @if(request()->routeIs('admin.ia.*'))
                        <div class="absolute left-0 top-0 h-full w-1 bg-[#1767A4]"></div>
                        @endif
                        <svg class="mr-4 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
